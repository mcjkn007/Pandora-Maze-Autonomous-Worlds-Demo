...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("game"), bytes16("StageComponent")));
bytes32 constant StageComponentTableId = _tableId;

library StageComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("StageComponent", _fieldNames);
  }
